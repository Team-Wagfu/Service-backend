...
from app.schemas.enums import ResponseStatus
from app.core.types import PetID, PetOwnerID, PetPassportID

#---------------------------------------------------------#
# All configurations are in DEBUG mode, need to change it #
#---------------------------------------------------------#
...
class PatientResponse(BaseModel):
    ...
    status: Annotated[ResponseStatus, Field(default=ResponseStatus.error, description="status of the Response")]
...
class PatientList(PatientResponse):
    data: Annotated[list[Patient], Field(default_factory=[], description="list of pets")]
